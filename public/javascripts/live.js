...
let liveStatusConfig = {
  ...
  cols: [
    ...
    { width: width_col1, autoheight: true, template: '최근 업데이트:' },
...
let activeLoansTableConfig = {
  ...
  columns: [
    ...
    { id: 'amount', header:[{ text: '비용', css: 'table-header-center' }], autowidth: true, adjust: true, sort: "int", tooltip: tooltip, cssFormat: alignRight, template: returnAmountTemplate },
    { id: 'duration', header: [{text: '기간', css: 'table-header-center' }], autowidth: true, adjust: true, sort: "int", tooltip: tooltip , cssFormat: alignCenter },
    { id: 'issuedAt', header:[{ text: '발생일', css: 'table-header-center' }], autowidth: true, adjust: true, sort: 'date', tooltip: tooltip, cssFormat: alignRight, template: returnIssuedAtTemplate },
    { id: 'fees', header: [{text: '수수료', css: 'table-header-center' }], adjust: true, autowidth: true, tooltip: tooltip, sort: "int", cssFormat: alignRight, template: returnFeesTemplate },
    { id: 'expiresAt', header:[{ text: '만료일', css: 'table-header-center' }], autowidth: true, adjust: true, sort: 'date', tooltip: tooltip, template: returnExpiresTemplate },
  ],
...
let openOffersTableConfig = {
  ...
  columns: [
    ...
    { id: 'amount', header:[{ text: '비용', css: 'table-header-center' }], autowidth: true, adjust: true, sort: "int", tooltip: tooltip, cssFormat: alignRight, template: returnAmountTemplate },
    { id: 'duration', header: [{text: '기간', css: 'table-header-center' }], autowidth: true, adjust: true, sort: "int", tooltip: tooltip , cssFormat: alignCenter },
    { id: 'issuedAt', header:[{ text: '발생일', css: 'table-header-center' }], autowidth: true, adjust: true, sort: 'date', tooltip: tooltip, cssFormat: alignRight, template: returnIssuedAgoTemplate },    
  ],
  fixedRowHeight:false,  rowLineHeight:25, rowHeight:25,
  data: [],
  tooltip: true,
  ...
  cols: [
    { gravity: 0.2 },
    {
      ...
      rows: [
        ...
        { view:"template", template:"상태", type:"section" },
        liveStatusConfig,
        { gravity: 0.2 },
        //{ view:"template", template:"Open Offers", type:"section" },
        { view:"template", template:"오퍼 중", type:"section" },        
        openOffersTableConfig,
        { gravity: 0.2 },
        //{ view:"template", template:"Active Loans", type:"section" },
        { view:"template", template:"유효한 대출", type:"section" },
