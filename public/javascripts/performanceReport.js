...
let performanceReportTableConfig = {
  ...
  columns: [
    ...
    { id: 'rateBTC', header:[{ text: '비율', css: 'table-header-center' }], autowidth: true, adjust: true, tooltip: tooltip, template: returnRateBTCTemplate },
    { id: 'startBalance', header:[{ text: '시작잔고', css: 'table-header-center' }], autowidth: true, adjust: true, sort: "int", tooltip: tooltip, cssFormat: alignRight },
    { id: 'totalFunds', header: [{text: '현재잔고', colspan: 2, css: 'table-header-center' }, { text: '잔고', css: 'table-header-center' }], autowidth: true, adjust: true, sort: "int", tooltip: tooltip , cssFormat: alignRight, template: returnTotalFundsTemplate },
    { id: 'totalFundsUSD', header:[null, { text: '달러가치', css: 'table-header-center' }], autowidth: true, adjust: true, tooltip: tooltip, cssFormat: alignRight },
    { id: 'activeLoansCount', header: [{text: '랜딩중', colspan: 2, css: 'table-header-center' },{ text: '랜딩수' }], adjust: 'data', autowidth: true, tooltip: tooltip },
    { id: 'activeLoansAmount', header:[null, { text: '잔고', css: 'table-header-center' }], autowidth: true, adjust: true, tooltip: tooltip, cssFormat: alignRight },
    { id: 'profit', header:[{text: '수익', colspan: 3, css: 'table-header-center' }, {text: '코인', css: 'table-header-center' }], autowidth: true, autoheight: true, adjust: true, tooltip: tooltip, template: returnProfitTemplate, cssFormat: alignRight },
    { id: 'profitPerc', header: [null, {text: '%', css: 'table-header-center' }], autowidth: true, adjust: true, sort: "int", tooltip: tooltip, template: returnProfitPercTemplate, cssFormat: alignRight },
    { id: 'profitUSD', header:[null, {text: '달러가치', css: 'table-header-center' }], autowidth: true, autoheight: true, adjust: true, tooltip: tooltip, template: returnProfitUSDTemplate, cssFormat: alignRight },
    { id: 'wmr', header: [{text: '<span title="Weighted average rate of active loans">WAR(Weighted average rate)</span>', colspan: 2, css: 'table-header-center' },{ text: '일일', css: 'table-header-center' }], autowidth: false, adjust: true, sort: "int", tooltip: tooltip, template: returnWmrTemplate, cssFormat: alignRight, tooltip: 'Weighted average rate of active loans' },
    { id: 'ewmr', header: [null, {text: '<span title="Daily rate minus Poloniex commision">유효</span>', css: 'table-header-center' }], autowidth: false, adjust: true, sort: "int", tooltip: tooltip, template: returnEwmrTemplate, cssFormat: alignRight, tooltip: 'daily rate minus Poloniex commision' },
    { id: 'apy', header:[{ text: '<span title="Annual Percentage Yield">연이자</span>', css: 'table-header-center' }], autowidth: true, adjust: true, tooltip: tooltip, template: returnAPYTemplate, cssFormat: alignRight, tooltip: 'Annual Percentage Yield' },
  ...
  cols: [
    { gravity: 0.2 },
    {
      ...
      rows: [
        ...
        { view:"template", template:"성과 보고", type:"section" },
